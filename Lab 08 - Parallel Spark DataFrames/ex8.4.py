...
if __name__ == "__main__":
    ...
    result = dataset.withColumn('day', sparkFun.substring('Measurement Timestamp', 1, 10))\
        .groupBy('Station Name', 'day').agg(
        sparkFun.min('Solar Radiation').alias('Min Solar radiation'),
    ...
    result.write.format("csv").option("header", True).save("ex8.4")
